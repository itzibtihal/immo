    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid px-4">
                <div class="row g-3 my-2">
                    <div class="col-md-3">
                        <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                            <div>
                                <h3 class="fs-2"><?php echo $userCountWithRoleId2; ?></h3>
                    ...
                    <div class="col-md-3">
                        <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                            <div>
                                <h3 class="fs-2"><?php echo $propertyCount; ?></h3>
                                <p class="fs-5">properties</p>
                            </div>
                            <i
                    ...
                    <div class="col-md-3">
                        <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                            <div>
                                <h3 class="fs-2"><?php echo $userCountWithRoleId3; ?></h3>
                                <p class="fs-5">Sellers</p>
                            </div>
                ...
                <div class="row my-5">
                    <h3 class="fs-4 mb-3 text-white">All the properties</h3>
                    <div class="col">

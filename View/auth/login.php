...
<div class="custom-bg rounded shadow-lg p-6 mt-12 md:flex md:items-center relative">
    ...
    <div class="md:w-1/2 mt-6 md:mt-0 md:ml-6">
        <div class="form-inputs-container bg-custom-dark p-8 rounded-lg shadow-md">
            ...
            <?php endif; ?>
            <form action="/immo/login" method="post">
                <div class="mb-6">
                    <label for="email" class="block text-white text-sm font-bold mb-2">Email:</label>
                    <input name="email" id="email" type="email" placeholder="Enter your email" class="more-width p-2 rounded focus:outline-none focus:shadow-outline"/>
                </div>

                <div class="mb-8">
                    <label for="password" class="block text-white text-sm font-bold mb-2">Password:</label>
                    <input name="password" id="password" type="password" placeholder="Enter your password" class="more-width p-2 rounded focus:outline-none focus:shadow-outline"/>
                </div>

                <div class="flex items-center justify-between">
                    <button name="processLogin" type="submit" class="sign-up-button bg-purple-600 hover:bg-purple-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline transition duration-300">Login</button>
                </div>
            </form>
